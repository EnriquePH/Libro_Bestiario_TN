...
\end{multline}
```
Sustituyendo en la serie problema, los valores obtenidos \@ref(eq:A000330-e), la expresión de los **números armónicos** \@ref(eq:armonicos1) y teniendo en cuenta la suma de la serie\@ref(eq:armonicos2):
