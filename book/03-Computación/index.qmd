...
Empleando el mismo método de cálculo se puede generalizar la fórmula \@ref(eq:integralfrac6) para obtener la integral indefinida de la parte entera de un número elevado a cualquier potencia entera.
...
\end{multline}
```
Sustituyendo los resultados anteriores: \@ref(eq:intsuelo2), \@ref(eq:integralfrac6) y \@ref(eq:integralsuelo2d) en \@ref(eq:integralfunc1)
